...
class S {
  ...
  /// `Welcome to yes_order`
  String get welcomeToyes_order {
    return Intl.message(
      'Welcome to yes_order',
      name: 'welcomeToyes_order',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Please enter your phone number to login into our platform`
  ...
  /// `Enter the sms code that send to number`
  String get confirmDescribtion {
    return Intl.message(
      'Enter the sms code that send to number',
      name: 'confirmDescribtion',
      desc: '',
      args: [],
    );
  }

  /// `Login success wlecome to our platform press the button to setup your profile`
  String get loginSucces {
    return Intl.message(
      'Login success wlecome to our platform press the button to setup your profile',
      name: 'loginSucces',
      desc: '',
  ...
  /// `Register success wlecome to our platform press the button to setup your profile`
  String get registerSucces {
    return Intl.message(
      'Register success wlecome to our platform press the button to setup your profile',
      name: 'registerSucces',
      desc: '',
  ...
  /// `Tap the plus icon to add a new Order`
  String get addNewOrderDescribtion {
    return Intl.message(
      'Tap the plus icon to add a new Order',
      name: 'addNewOrderDescribtion',
      desc: '',
      args: [],
    );
  }
