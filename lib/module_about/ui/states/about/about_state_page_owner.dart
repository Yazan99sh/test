          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.only(right: 35, left: 35),
                  child: Text(
                    '${S.of(context).bookACarDescribtion}',
                    style: TextStyle(
                        height: 2,
                        fontWeight: FontWeight.bold,
                        color: Colors.grey),
            ...
            Column(
              ...
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.only(right: 35, left: 35),
                  child: Text(
                    '${S.of(context).weDeliverDescribtion}',
                    style: TextStyle(
                        height: 2,
                        fontWeight: FontWeight.bold,
                        color: Colors.grey),
            ...
            Column(
              ...
              children: [
                Padding(
                  padding:
                      const EdgeInsets.only(right: 25.0, left: 25.0, top: 25),
                  child: Text(
